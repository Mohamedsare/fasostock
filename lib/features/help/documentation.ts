    ...
    articles: [
      ...
      },
      {
        ...
        blocks: [
          ...
          {
            kind: "p",
            text: "Détail des encaissements — le propriétaire peut ajouter un volet repliable sous les chiffres du jour et sous ceux de la période. Il ventile l'argent encaissé par moyen de paiement : combien en espèces, combien par Orange Money, Moov Money, Wave, carte ou virement, avec le nombre de règlements de chacun. Une fois déplié, il commence par la question du soir : combien de liquide dans le tiroir, combien sur vos comptes. Cela s'active dans Paramètres › « Tableau de bord — détail des encaissements » ; désactivé, la page ne change pas d'un pixel.",
          },
        ],
        keywords: [
          "accueil",
    ...
    articles: [
      {
        ...
        blocks: [
          ...
          {
            kind: "bullets",
            title: "Remplir le stock en un clic (à activer dans Paramètres)",
            items: [
              "Le propriétaire ouvre le réglage « Remplir le stock en un clic » dans Paramètres. Une case apparaît alors devant chaque produit de la page Stock.",
              "« Tout cocher » coche toute la liste affichée, filtres compris — donc, au besoin, uniquement les produits en rupture ou d'une seule catégorie.",
              "Le bouton « Remplir le stock » demande une seule quantité pour toute la sélection ; chaque ligne reste modifiable avant de valider.",
              "Deux modes : « Ajouter au stock » (livraison reçue) ou « Mettre le stock à » (quantité comptée, qui remplace la valeur affichée).",
              "Chaque produit reçoit son mouvement de stock signé, comme un ajustement normal. Réservé aux employés ayant le droit « Ajuster le stock ».",
            ],
          },
          {
            kind: "note",
            ...
            text: "Un ajustement corrige une ligne. Pour recompter tout le magasin, passez par une session d'inventaire : vous garderez la trace des écarts, ce qu'un ajustement ne fait pas. La saisie groupée sert à REMPLIR vite (démarrage, grosse livraison), pas à contrôler.",
          },
        ],
        keywords: [
          "stock",
