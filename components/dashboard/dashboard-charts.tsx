  ...
  return (
    <div className="relative w-full">
      ...
      {hoverIdx !== null && pts[hoverIdx] ? (
        <div
          role="tooltip"
          className="pointer-events-none fixed z-50 w-[220px] rounded-sm border border-black/8 bg-white/95 px-3 py-2 text-xs shadow-lg backdrop-blur-sm dark:border-white/10 dark:bg-neutral-900/95"
          style={tooltipStyle}
        >
...
export function DashboardPieChart({
  ...
  return (
    ...
    >
      ...
      <ul
        className={cn(
          "space-y-1 rounded-md border border-black/6 bg-fs-surface-low/60 p-2 min-[900px]:space-y-1.5 dark:border-white/8 dark:bg-white/[0.04]",
          ...
          return (
            <li key={seg.key}>
              <div
                role="presentation"
                className={cn(
                  "flex w-full cursor-default items-center gap-2.5 rounded-sm px-2 py-2 text-left text-xs transition-colors min-[900px]:text-sm",
                  active
