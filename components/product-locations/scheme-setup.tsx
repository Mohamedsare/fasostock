        ...
        <div className="grid grid-cols-1 gap-2.5 sm:grid-cols-2 xl:grid-cols-3">
          {LOCATION_TEMPLATES.map((t) => (
            <button
              ...
              className="group flex flex-col items-start rounded-lg border border-black/[0.08] bg-fs-card p-4 text-left shadow-sm transition-colors hover:border-fs-accent/60 hover:bg-fs-accent/[0.03]"
            >
          ...
          <button
            type="button"
            onClick={startCustom}
            className="flex flex-col items-start rounded-lg border border-dashed border-fs-accent/50 bg-fs-accent/[0.04] p-4 text-left transition-colors hover:bg-fs-accent/[0.08]"
          >
    ...
    <FsCard padding="p-4 sm:p-5">
      ...
      <div className="mt-4 space-y-2">
        {levels.map((lvl, i) => (
          <div
            key={i}
            className="flex items-center gap-2 rounded-[8px] border border-black/[0.08] bg-fs-surface-container/50 p-2"
          >
      ...
      <button
        ...
        disabled={!canAdd}
        className="mt-2.5 inline-flex items-center gap-1.5 rounded-[8px] border border-dashed border-fs-accent/50 px-3 py-2 text-xs font-semibold text-fs-accent disabled:opacity-40"
      >
      ...
      {names.some((n) => n.trim() !== "") ? (
        <div className="mt-4 rounded-[8px] bg-fs-surface-container/70 p-3">
