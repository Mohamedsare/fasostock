...
/**
 * Enveloppe des dialogues du module « Devis & Factures » : feuille glissante en bas
 * sur mobile, boîte centrée sur grand écran. Même géométrie que les autres modules.
 */
export function SaleDocumentDialogShell({
  title,
  subtitle,
  onClose,
  children,
...
export function SaleDocumentField({
  label,
  hint,
  children,
  className,
...
/** Titre de section à l'intérieur d'un dialogue long. */
export function SaleDocumentSection({
  title,
  hint,
  children,
}: {
