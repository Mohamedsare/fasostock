...
/**
 * Enveloppe commune des dialogues du module Location : feuille glissante en bas
 * sur mobile, boîte centrée sur grand écran (même géométrie que les autres
 * modules de l'app).
 */
export function RentalDialogShell({
  title,
  subtitle,
  icon,
  onClose,
  ...
  return (
    <div
      className={cn(
        "fixed inset-0 flex items-end justify-center bg-black/45 p-0 min-[560px]:items-center min-[560px]:p-4",
        zIndex,
      )}
      role="presentation"
...
/** Champ de formulaire libellé — homogénéise tous les dialogues du module. */
export function RentalField({
  label,
  hint,
  children,
  className,
...
/** Bouton principal plein largeur des dialogues. */
export function RentalSubmitButton({
  label,
  onClick,
  disabled,
  busy,
